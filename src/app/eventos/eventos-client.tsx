...
export function EventosClient({ initialEvents }: { initialEvents: EventCardData[] }) {
  return (
    <Suspense>
      <EventosContent allEvents={initialEvents} />
    </Suspense>
  );
}

function EventosContent({ allEvents }: { allEvents: EventCardData[] }) {
